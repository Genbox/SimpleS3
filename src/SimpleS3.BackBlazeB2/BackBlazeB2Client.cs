...
namespace Genbox.SimpleS3.BackBlazeB2
{
    ...
    public sealed class BackBlazeB2Client : ClientBase, ISimpleClient
    {
        ...
        internal BackBlazeB2Client(IObjectClient objectClient, IBucketClient bucketClient, IMultipartClient multipartClient, IMultipartTransfer multipartTransfer, ITransfer transfer) : base(objectClient, bucketClient, multipartClient, multipartTransfer, transfer) { }
