...
namespace Genbox.SimpleS3.Extensions.AwsS3.Tests.OnlineTests.Buckets
{
    public class ListBucketsTests : OnlineTestBase
    {
        ...
        public async Task ListBuckets()
        {
            ...
            Assert.Equal(DateTime.UtcNow, bucketObj.CreatedOn.UtcDateTime, TimeSpan.FromSeconds(5));
        }
    }
}