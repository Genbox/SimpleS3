...
namespace Genbox.SimpleS3.Core.Network.Responses.Objects
{
    public class ListPartsResponse : BaseResponse, IHasRequestCharged, IHasAbort, IHasTruncated, IHasStorageClass, IHasUploadId
    {
        ...
        /// <summary>
        /// Identifies the object owner, after the object is created. If multipart upload is initiated by an IAM user, this element provides the parent account ID and display name.
        /// </summary>
        public S3Identity Owner { get; internal set; }

        /// <summary>
        /// Identifies who initiated the multipart upload. If the initiator is an AWS account, this element provides the same information as the Owner element. If the initiator is an IAM User, then this element provides the user ARN and display name.
        /// </summary>
