...
namespace Genbox.SimpleS3.Core.Requests.Objects
{
    ...
    /// </summary>
    public class GetObjectRequest : BaseRequest, IRangeProperties, ICacheProperties, ISseCustomerKeyProperties, IResponseHeaderProperties
    {
        ...
        /// <summary>Version ID used to reference a specific version of the object.</summary>
