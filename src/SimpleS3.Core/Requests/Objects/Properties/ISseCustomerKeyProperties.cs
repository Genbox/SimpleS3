...
{
    /// <summary>
    /// This represents Server Side Encryption (SSE) with Customer key (SSE-C). You provide a key for Amazon to encrypt your data with. Note that
    /// Amazon does not keep this kep. Data is encrypted with the key, and then the key is discarded.
    /// </summary>
    [PublicAPI]
    public interface ISseCustomerKeyProperties : IContainSensitiveMaterial
    {
