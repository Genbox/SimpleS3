...
public sealed class GenericS3Client : ClientBase, ISimpleClient
{
    ...
    public GenericS3Client(string keyId, byte[] accessKey, string endpoint, string regionCode, NetworkConfig? networkConfig = null) : this(new GenericS3Config(new AccessKey(keyId, accessKey), endpoint, regionCode), networkConfig) {}
    ...
    /// <param name="regionCode">The region code to use</param>
    /// <param name="networkConfig">Network configuration</param>
    public GenericS3Client(string keyId, string accessKey, string endpoint, string regionCode, NetworkConfig? networkConfig = null) : this(new GenericS3Config(new StringAccessKey(keyId, accessKey), endpoint, regionCode), networkConfig) {}
    ...
    internal GenericS3Client(IObjectClient objectClient, IBucketClient bucketClient, IMultipartClient multipartClient, IMultipartTransfer multipartTransfer, ITransfer transfer, ISignedObjectClient signedObjectClient) : base(objectClient, bucketClient, multipartClient, multipartTransfer, transfer, signedObjectClient) {}
