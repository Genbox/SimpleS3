...
{
    /// <summary>Securely reads a secret from console. Not only does it print out '*' for each entry, it also reads it into a char[], which can be cleared, which strings cannot.</summary>
