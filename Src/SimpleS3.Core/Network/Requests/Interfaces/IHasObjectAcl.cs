...
[PublicAPI]
public interface IHasObjectAcl
{
    /// <summary>The canned ACL to apply to the object.</summary>
    ObjectCannedAcl Acl { get; set; }

    /// <summary>To explicitly grant access permissions to specific AWS accounts or a group, use the following headers. Each
    /// maps to specific permissions that Amazon S3 supports in an ACL.</summary>
