...
public interface IHasObjectAcl
{
    ...
    /// <summary>
    /// To explicitly grant access permissions to specific AWS accounts or a group, use the following headers. Each maps to specific permissions that Amazon S3 supports in an
    /// ACL.
    /// </summary>
