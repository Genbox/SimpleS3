...
public class ListObjectsResponse : BaseResponse, IHasTruncated, IHasTruncatedExt, IHasRequestCharged, IHasBucketName
{
    ...
    /// <summary>
    /// KeyCount is the number of keys returned with this request. KeyCount will always be less than equals to MaxKeys field. Say you ask for 50 keys, your result will include
    ...
    /// <summary>
    /// NextContinuationToken is sent when isTruncated is true which means there are more keys in the bucket that can be listed. The next list requests to Amazon S3 can be
    /// continued with this NextContinuationToken. NextContinuationToken is obfuscated and is not a real key
    /// </summary>
