...
public interface IHasResponseContent : IHasLastModified
{
    ...
    /// <summary>
    /// Indicates if the content is expected to be displayed inline in the browser, that is, as a Web page or as part of a Web page, or as an attachment, that is downloaded and
    /// saved locally.
    /// </summary>
    ...
    /// <summary>Used to describe the language(s) intended for the audience, so that it allows a user to differentiate according to the users' own preferred language.</summary>
