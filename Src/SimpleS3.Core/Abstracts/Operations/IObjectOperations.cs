...
public interface IObjectOperations
{
    ...
    /// <summary>
    /// Set the access control list (ACL) permissions for an object that already exists in a bucket. See https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutObjectAcl.html for
    /// details
    /// </summary>
