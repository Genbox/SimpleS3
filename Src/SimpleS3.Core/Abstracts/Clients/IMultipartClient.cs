...
{
    /// <summary>Create a multipart upload. Once created, you can start uploading parts to it. Remember to call either
    /// <see cref="CompleteMultipartUploadAsync" /> or <see cref="AbortMultipartUploadAsync" /> when you are finished.</summary>
    ...
    /// <summary>Upload a part to a multipart upload. You must call <see cref="CreateMultipartUploadAsync" /> before you can
    /// upload parts to it.</summary>
