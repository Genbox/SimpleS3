...
{
    /// <summary>
    /// Create a multipart upload. Once created, you can start uploading parts to it. Remember to call either <see cref="CompleteMultipartUploadAsync" /> or
    /// <see cref="AbortMultipartUploadAsync" /> when you are finished.
    /// </summary>
