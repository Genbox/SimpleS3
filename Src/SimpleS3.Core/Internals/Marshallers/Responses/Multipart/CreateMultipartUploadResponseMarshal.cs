...
{
    public void MarshalResponse(SimpleS3Config config, CreateMultipartUploadResponse response, IDictionary<string, string> headers, ContentStream responseStream)
    {
