...
{
    public void MarshalResponse(SimpleS3Config config, PutBucketLockConfigurationResponse response, IDictionary<string, string> headers, ContentStream responseStream)
    {
