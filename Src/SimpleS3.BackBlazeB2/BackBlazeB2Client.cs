...
public sealed class BackBlazeB2Client : ClientBase, ISimpleClient
{
    ...
    public BackBlazeB2Client(string keyId, byte[] accessKey, BackBlazeB2Region region, NetworkConfig? networkConfig = null) : this(new BackBlazeB2Config(new AccessKey(keyId, accessKey), region), networkConfig) {}
    ...
    /// <param name="region">The region you wish to use</param>
    /// <param name="networkConfig">Network configuration</param>
    public BackBlazeB2Client(string keyId, string accessKey, BackBlazeB2Region region, NetworkConfig? networkConfig = null) : this(new BackBlazeB2Config(new StringAccessKey(keyId, accessKey), region), networkConfig) {}
    ...
    public Task<PutBucketVersioningResponse> PutBucketVersioningAsync(string bucketName, bool enabled, Action<PutBucketVersioningRequest>? config = null, CancellationToken token = default) => throw new NotSupportedException(ErrorMessages.ProviderNotSupported);
    ...
    public IAsyncEnumerable<GetObjectResponse> MultipartDownloadAsync(string bucketName, string objectKey, Stream output, int bufferSize = 16777216, int numParallelParts = 4, Action<GetObjectRequest>? config = null, CancellationToken token = default) => throw new NotSupportedException(ErrorMessages.ProviderNotSupported);
