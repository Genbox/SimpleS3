...
/// <summary>
/// Implementation of <see cref="IUnhandledExceptionHandler" /> that stores an unhandled exception so it can later
/// be rethrown by <see cref="CommandLineService{T}" />.
/// </summary>
internal class StoreExceptionHandler : IUnhandledExceptionHandler
{
    ...
    /// If called a second time an <see cref="AggregateException" /> containing both
