...
public enum BucketNameValidationMode
{
    ...
    /// <summary>
    /// Bucket name validation is up to the provider. In strict mode, a smaller set of characters (defined by the provider) is allowed for safety and compatibility. If you are
